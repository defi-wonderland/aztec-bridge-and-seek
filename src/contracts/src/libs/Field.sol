...
library Field {
    ...
    function toFieldReduce(uint256 a) internal pure returns (Field.Type b) {
        b = Field.Type.wrap(a % PRIME);
    }
    ...
    function toFieldReduce(bytes32 a) internal pure returns (Field.Type b) {
        b = Field.Type.wrap(uint256(a) % PRIME);
    }
