...
contract DeploySwapHook is Script {
    function run() external returns (SwapHook swapHook) {
        ...
        address swapOutputToken = vm.envOr("SWAP_OUTPUT_TOKEN", address(0xA52B8d7D08f2aC091feE807fCc7FD20D1da05bB1)); // USDC
        bytes32 swapOutputTokenAztec = vm.envOr("SWAP_OUTPUT_TOKEN_AZTEC", bytes32(0x212028585111d48bdb2b447c070d44acd5c5c10dc6973879f7a128d631f4dcb4)); // USDC in Aztec
        ...
        console.log("Swap Output Token:", swapOutputToken);
